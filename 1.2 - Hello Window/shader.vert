#version 330 core
//First line should always be a #version statement; this just tells the GLSL compiler what version it should use


//GLSL is laid out somewhat like C, but it has a few differences.
...
//The vertex shader is run once for every vertex. In pseudocode, it might look something like:
//foreach vertex in vertices:
//	run shader on vertex
...
//It's only used in some more advanced OpenGL things; it's not needed here.
